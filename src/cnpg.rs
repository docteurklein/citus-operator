...
// kopium command: kopium -D Default -Af -
...
pub struct ClusterStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "rolePasswordStatus")]
    pub role_password_status: Option<BTreeMap<String, ClusterStatusRolePasswordStatus>>,
    /// RoleStatus gives the list of roles in each state
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "roleStatus")]
    pub role_status: Option<BTreeMap<String, String>>,
...
/// RolePasswordStatus gives the last transaction id and hash for each managed role
#[derive(Serialize, Deserialize, Clone, Debug, Default, JsonSchema)]
pub struct ClusterStatusRolePasswordStatus {
